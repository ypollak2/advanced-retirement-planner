...
const Dashboard = ({ 
    ...
    // More comprehensive check for user data - only show net worth if user has meaningful financial data
    ...
    const calculateNetWorth = () => {
        ...
        // Only calculate if we have meaningful inputs and user data
        if (hasUserData && inputs) {
            ...
            if (window.calculateTotalCurrentSavings) {
                ...
                baseNetWorth = (parseFloat(inputs.currentSavings) || 0) + 
                              ...
                              (parseFloat(inputs.currentSavingsAccount) || 0);
                console.log('Dashboard: Using fallback savings calculation:', baseNetWorth);
            }
        }
        
        // Ensure we never return negative values or NaN
    ...
    return React.createElement('div', {
        ...
        React.createElement('div', {
            ...
            // Net Worth Tracker (always show, with 0 if no data)
            React.createElement('div', {
                key: 'net-worth',
